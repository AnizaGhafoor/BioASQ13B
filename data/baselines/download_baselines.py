...
class MP_PubmedLinks(BaseProcess):
    ...
    def __call__(self):
        ...
        # Use a regular expression to find all .xml.gz files in the listing
...
if __name__ == '__main__':
    ...
    pipeline = Pipeline([
        ...
        MP_PubmedDownloaderAndParser(num_processes=4, size_queue=1000),
        MP_JsonlWriter(f"baselines/pubmed_baseline_2025.jsonl")
    ], total_samples=38_000_000)
